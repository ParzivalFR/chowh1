const EmbedTwitch = () => {
  return (
    <section className="w-full md:w-4/5 flex flex-col md:flex-row m-auto">
      <iframe
        src="https://player.twitch.tv/?channel=chowh1&parent=https://chowh1.vercel.app&muted=true"
        height="300"
        width="500"
      ...
      ></iframe>
      <iframe
        src="https://www.twitch.tv/embed/chowh1/chat?parent=https://chowh1.vercel.app&darkpopout"
        height="300"
        width="250"
